...
<%
    ...
    String queryMaxCalories = "SELECT id, calories, date, intake FROM calories WHERE calories = (SELECT MAX(calories) FROM calories WHERE id=?) AND id=?";
    MyDb db = new MyDb();
