                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="account-general">
                        <div class="card-body media align-items-center">
                            <img src="Images/WhatsApp%20Image%202024-06-23%20at%2000.09.40.jpeg" alt class="d-block ui-w-80">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-1" value="48" disabled></label>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Doctor Name</label>
                                <input type="text" class="form-control" value="Muhammad Bilal Khan" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">E-mail Address</label>
                                <input type="text" class="form-control mb-1" value="bilalk@ihc.health.pk" disabled>
                    ...
                    <div class="tab-pane fade" id="account-info">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="+92 325-864613" disabled>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="account-social-links">
                        <div class="card-body pb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="https://twitter.com/bilalk" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Facebook</label>
                                <input type="text" class="form-control" value="https://www.facebook.com/bilalk" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Google+</label>
                                <input type="text" class="form-control" value="https://plus.google.com/bilalk" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">LinkedIn</label>
                                <input type="text" class="form-control" value="https://www.linkedin.com/in/bilalk" disabled>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Instagram</label>
                                <input type="text" class="form-control" value="https://www.instagram.com/bilalk" disabled>
                            </div>
                        </div>
                    </div>
