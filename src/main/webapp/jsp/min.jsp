...
<%
    ...
    String queryMaxCalories = "SELECT id, calories, date, intake FROM calories WHERE calories = (SELECT MIN(calories) FROM calories WHERE id=?) AND id=?";
    MyDb db = new MyDb();
    ...
    try {
        ...
        pstmt = connection.prepareStatement(queryMaxCalories);
        pstmt.setInt(1, id);
        pstmt.setInt(2, id);
...
<main class="table" id="calories_table">
    ...
    <section class="table__body">
        <table class="table">
            ...
            %>
            <tr>
                <td colspan="4">No records found for ID <%= id %> with maximum calories</td>
            </tr>
            <%
                    }
