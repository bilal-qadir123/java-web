...
<head>
  ...
  <title>Doctor Rafay Arshad</title>
        ...
        <div class="tab-content">
          <div class="tab-pane fade active show" id="account-general">
            <div class="card-body media align-items-center">
              <img src="Images/WhatsApp Image 2024-06-15 at 16.44.26.jpeg" alt class="d-block ui-w-80">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control mb-1" value="21" disabled></label>
              </div>
              <div class="form-group">
                <label class="form-label">Doctor Name</label>
                <input type="text" class="form-control" value="Abdul Rafay Arshad" disabled>
              </div>
              <div class="form-group">
                <label class="form-label">E-mail Address</label>
                <input type="text" class="form-control mb-1" value="rafayarshad@ihc.health.pk" disabled>
          ...
          <div class="tab-pane fade" id="account-info">
            ...
            <div class="card-body pb-2">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="+92 342-249852" disabled>
              </div>
              <div class="form-group">
          ...
          <div class="tab-pane fade" id="account-social-links">
            <div class="card-body pb-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="https://twitter.com/rafay" disabled>
              </div>
              <div class="form-group">
                <label class="form-label">Facebook</label>
                <input type="text" class="form-control" value="https://www.facebook.com/rafay" disabled>
              </div>
              <div class="form-group">
                <label class="form-label">Google+</label>
                <input type="text" class="form-control" value="https://plus.google.com/rafay" disabled>
              </div>
              <div class="form-group">
                <label class="form-label">LinkedIn</label>
                <input type="text" class="form-control" value="https://www.linkedin.com/in/rafay" disabled>
              </div>
              <div class="form-group">
                <label class="form-label">Instagram</label>
                <input type="text" class="form-control" value="https://www.instagram.com/rafay" disabled>
              </div>
            </div>
          </div>
