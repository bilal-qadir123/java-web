...
<%
    String query = "SELECT id, calories, date, intake FROM calories WHERE id=?";
    MyDb db = new MyDb();
...
<main class="table" id="calories_table">
    ...
    <section class="table__header">
        ...
        <button id="avgButton" onclick="redirectToAvgPage(<%= id %>)" class="btn btn-primary">
            Avg
        </button>
        <button id="orderByButton" onclick="redirectToOrderByPage(<%= id %>)" class="btn btn-primary">
            Order By Asc
        </button>
        <button id="orderByDscButton" onclick="redirectToOrderByDscPage(<%= id %>)" class="btn btn-primary">
            Order By Dsc
        </button>
    </section>
    ...
    <section class="table__body">
        <table class="table">
            ...
            %>
            <tr>
                <td colspan="4">No records found for ID <%= id %></td>
            </tr>
            <%
                }
            } catch (Exception e) {
...
<script>
    ...
    function redirectToOrderByPage(id) {
        window.location.href = 'orderBy.jsp?id=' + id;
    }
    function redirectToOrderByDscPage(id) {
        window.location.href = 'orderByDsc.jsp?id=' + id;
    }
    function redirectToAvgPage(id) {
        window.location.href = 'avg.jsp?id=' + id;
    }
</script>
</body>
</html>
